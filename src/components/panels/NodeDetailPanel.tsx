...
export function NodeDetailPanel({
  ...
  return (
    <div
      className={cn(
        'fixed bottom-0 right-0 top-14 w-[400px] border-l border-gray-200 bg-white shadow-lg',
      ...
      {node && (
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
            <h3 className="font-semibold text-gray-900">{isGroup ? 'Group Details' : 'Node Details'}</h3>
            ...
            <div>
              ...
              {isGroup && children.length > 0 ? (
                <div className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-500">
                  Group <span className="text-[10px] text-gray-400 ml-1">(has children)</span>
                </div>
              ) : (
                <select
                  value={type}
