...
<div class="flex items-center justify-center min-h-screen">
	<div class="w-full max-w-sm p-8 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
		...
		<p class="text-sm text-[var(--color-text-muted)] text-center mb-6">Sign in to your account</p>
		...
		<p class="mt-4 text-center text-sm text-[var(--color-text-muted)]">
			Don't have an account? <a href="/register" class="text-[var(--color-primary)] hover:underline">Sign up</a>
		</p>
	</div>
</div>
