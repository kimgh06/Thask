...
<div class="landing">
	...
	<nav class="nav">
		<div class="nav-inner">
			...
			<div class="nav-links" class:nav-links-open={menuOpen}>
				<a href="#features" class="nav-link" onclick={() => menuOpen = false}>Features</a>
				<a href="#tech" class="nav-link" onclick={() => menuOpen = false}>Tech Stack</a>
				<a href="#deploy" class="nav-link" onclick={() => menuOpen = false}>Deploy</a>
				<a href="https://github.com/kimgh06/Thask" target="_blank" rel="noopener" class="nav-link">GitHub</a>
				<a href="/login" class="btn btn-primary btn-sm">Sign in</a>
			</div>
			<button class="nav-hamburger" onclick={() => menuOpen = !menuOpen} aria-label="Toggle menu">
	...
	<section id="deploy" class="section section-alt">
		<div class="container">
			...
			<p class="section-subtitle">Configure a few environment variables and you're live.</p>

			<div class="deploy-grid">
				<div class="deploy-card">
					<h4 class="deploy-card-title">Environment Variables</h4>
					<div class="deploy-table">
						...
						<div class="deploy-row">
							...
							<span>Session signing key (required)</span>
							<span class="deploy-muted">auto-generated by <code>make up</code></span>
						</div>
						<div class="deploy-row">
							<code>APP_URL</code>
							<span>Public URL of the app</span>
							<code>http://localhost:7243</code>
						</div>
						<div class="deploy-row">
							<code>BACKEND_URL</code>
							<span>Backend URL for frontend proxy</span>
							<code>http://backend:7244</code>
						</div>
						<div class="deploy-row">
							<code>POSTGRES_PASSWORD</code>
							<span>Database password</span>
							<code>thask_password</code>
						</div>
					</div>
				</div>

				<div class="deploy-card">
					<h4 class="deploy-card-title">Custom Domain Example</h4>
					<div class="terminal deploy-terminal">
						...
						<div class="terminal-body">
							<p><span class="deploy-comment"># .env</span></p>
							<p><span class="deploy-key">APP_URL</span>=https://thask.example.com</p>
							<p><span class="deploy-key">SESSION_SECRET</span>=your-random-64-char-string</p>
						</div>
					</div>
					<div class="deploy-arch">
						<div class="deploy-arch-row">
							<span class="deploy-arch-node">Browser</span>
							<span class="deploy-arch-arrow">&rarr;</span>
							<span class="deploy-arch-node">Reverse Proxy<span class="deploy-arch-sub">nginx / Caddy / Cloudflare</span></span>
						</div>
						<div class="deploy-arch-row">
							<span class="deploy-arch-node">Frontend<span class="deploy-arch-sub">:7243</span></span>
							<span class="deploy-arch-arrow">&rarr;</span>
							<span class="deploy-arch-node">Backend<span class="deploy-arch-sub">:7244 (Docker internal)</span></span>
							<span class="deploy-arch-arrow">&rarr;</span>
							<span class="deploy-arch-node">PostgreSQL<span class="deploy-arch-sub">:5432 (Docker internal)</span></span>
						</div>
					</div>
				</div>
			</div>
